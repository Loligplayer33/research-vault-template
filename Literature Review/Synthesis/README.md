...
This folder contains the thematic synthesis notes where cross-paper argument develops during the literature review. Each note corresponds to a specific theme, dimension, or argument your project needs to make.
...
Every synthesis note should generally use the same shape:
